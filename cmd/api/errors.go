...
func (app *application) userNoOwnerResponse(w http.ResponseWriter, r *http.Request) {
	app.clientErrorResponse(w, r, http.StatusBadRequest, "user is not owner")
}
...
func (app *application) userAlreadyExistsResponse(w http.ResponseWriter, r *http.Request) {
